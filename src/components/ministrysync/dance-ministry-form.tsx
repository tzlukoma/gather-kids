            ...
            <Alert>
                <AlertDescription>
                    <div className="space-y-4">
                        ...
                        />
                        <p>Thank you for registering for the Dance Ministry. You will receive information from ministry leaders regarding next steps for your child's participation.</p>
                    </div>
                </AlertDescription>
            </Alert>
        </div>
