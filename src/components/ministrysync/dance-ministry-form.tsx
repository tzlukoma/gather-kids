    ...
    return (
        <div className="mt-4 space-y-4">
            ...
            />
             <Alert>
                <AlertDescription>
                    Thank you for registering for the Dance Ministry. You will receive information from ministry leaders regarding next steps for your child's participation.
                </AlertDescription>
            </Alert>
        </div>
    )
