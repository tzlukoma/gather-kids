...
import { Info, CheckCircle, Smartphone, User, Camera, Cake, AlertTriangle, ShieldAlert } from "lucide-react";
            ...
            <CardHeader className="flex flex-col items-center gap-4 p-4 pt-6 text-center sm:flex-row sm:items-start sm:p-6 sm:text-left">
                <div className="relative w-40 h-40 sm:w-[60px] sm:h-[60px] flex-shrink-0">
                    <Button
                        ...
                        onClick={() => child.photo_url && onViewPhoto({ name: `${child.first_name} ${child.last_name}`, url: child.photo_url })}
                    >
