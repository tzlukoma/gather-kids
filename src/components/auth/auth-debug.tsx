...
import { Bug, User, Settings, Globe, Lock } from 'lucide-react';
...
export function AuthDebug({ children, showInProduction = false }: AuthDebugProps) {
	...
	const sessionInfo = {
		...
		lastActivity: user ? new Date().toISOString() : 'N/A',
		storageMethod: 'localStorage (demo mode)',
	};
								...
								<>
									<div className="space-y-2">
										...
										<div className="flex justify-between items-center">
											...
											<Badge>{user.metadata.role}</Badge>
										</div>
										<div className="flex justify-between items-center">
