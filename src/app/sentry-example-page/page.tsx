    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://gatherkids-app.sentry.io/issues/?project=4510016148799488">Issues Page</a>.
