  ...
  return (
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-muted-foreground">Overview of leader activity and assignments.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Leaders currently active and assigned</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Click a row to open the leader profile.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
                ...
                <TableRow key={leader.user_id} className="cursor-pointer">
                  ...
                  <TableCell>
                    {leader.assignments.length > 0 ? (
                      <span className="text-sm text-muted-foreground">{leader.assignments.map((a: any) => a.ministryName).join(', ')}</span>
                    ) : (
