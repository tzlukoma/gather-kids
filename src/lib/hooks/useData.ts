...
import type { Child, Guardian, Household, EmergencyContact, Attendance, Incident, Ministry, MinistryEnrollment } from '@/lib/types';
...
export function useMinistries(activeOnly?: boolean) {
    return useQuery({
        queryKey: queryKeys.ministries(activeOnly),
