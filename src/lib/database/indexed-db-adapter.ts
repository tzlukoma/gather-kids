...
export class IndexedDBAdapter implements DatabaseAdapter {
	...
	async updateEmergencyContact(householdId: string, contact: EmergencyContact): Promise<void> {
		// In demo mode, we'll just update the first emergency contact for the household
	...
	async logAudit(log: Omit<AuditLogEntry, 'id' | 'created_at'>): Promise<void> {
		...
		// In demo mode, we just log to console
		// Could implement actual storage if needed
	}
}