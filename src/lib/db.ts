...
class GatherKidsDB extends Dexie {
    ...
    // NEW: Canonical Bible Bee stores (snake_case)
    bible_bee_enrollments!: EntityTable<any, 'id'>; // Will be defined in canonical DTOs
    student_scriptures!: EntityTable<any, 'id'>; // Will be defined in canonical DTOs
    // Branding settings
    ...
    constructor() {
        ...
        this.version(1).stores({
            ...
            divisions: 'id, bible_bee_cycle_id, [bible_bee_cycle_id+name], [bible_bee_cycle_id+min_grade+max_grade]',
            essay_prompts: 'id, bible_bee_cycle_id, division_id, [bible_bee_cycle_id+division_id]',
            bible_bee_enrollments: 'id, bible_bee_cycle_id, child_id, division_id, [bible_bee_cycle_id+child_id]',
            enrollment_overrides: 'id, bible_bee_cycle_id, child_id, division_id, [bible_bee_cycle_id+child_id]',
            student_scriptures: 'id, bible_bee_cycle_id, child_id, scripture_id, [bible_bee_cycle_id+child_id+scripture_id]',
            // Branding settings
